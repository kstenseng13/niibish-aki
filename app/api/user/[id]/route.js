...
export async function PUT(req) {
    try {
        ...
        if (updatedUser) {
            ...
            return new Response(JSON.stringify({ message: "Update successful", user: processedUser }), { status: 200 });
        }

        return new Response(JSON.stringify({ message: "Update successful but user data not found" }), { status: 200 });
    } catch (error) {
