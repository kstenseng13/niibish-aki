        ...
        <div>
            <nav className="navBarContainer">
                ...
                <div className="hidden navBarMenu lg:block lg:text-xl hover:text-stone-950" id="navbarCart">
                    <a href="/cart"><Image width={24} height={24} src="https://cdn.iconscout.com/icon/free/png-512/free-shopping-cart-icon-download-in-svg-png-gif-file-formats--trolley-online-user-interface-pack-icons-1502238.png?f=webp&w=256"
                        alt="Akveo (Creator).(2019, July 30). Free Shopping Cart Icon [Digital image]. Retrieved from URL https://iconscout.com/icon/free/png-512/free-shopping-cart-icon-download-in-svg-png-gif-file-formats--trolley-online-user-interface-pack-icons-1502238.png?f=webp&w=256" className="ml-4 w-8 h-8"/>
                    </a>
                </div>
            </nav>
            <nav id="mobileMenu" className="hidden lg:hidden w-full bg-whiteSmoke">
                <ul>
                    ...
                    <li className="text-2xl py-8 px-4 font-semibold border-b border-amber-700/15 hover:bg-amber-700/10"><a href="/login" className="block w-full h-full">Login</a></li>
